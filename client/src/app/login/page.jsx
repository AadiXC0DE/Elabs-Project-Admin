...
const LoginPage = () => {
  ...
  useEffect(() => {
    alert("Please SignUp if you are a new user!!");
  }, []);

  const handleLogin = async () => {
    try {
      const endpoint =
        "https://elabs-proj-eval-api.el.r.appspot.com/api/v1/proj/login";
  ...
  const handleSignUp = async () => {
    try {
      const endpoint =
        "https://elabs-proj-eval-api.el.r.appspot.com/api/v1/proj/crtUser";
      ...
      <div className="bg-white rounded-xl p-10 shadow-lg max-w-xl">
        <div className="flex flex-col items-center justify-center mb-5">
          <div className="flex items-center mb-2">
            <h1 className="text-6xl font-bold text-yellow-500 mr-2 ">ELABS</h1>
            <h2 className="text-6xl font-semibold text-gray-900">PROJECT</h2>
          </div>
        </div>
